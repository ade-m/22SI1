...
def tampilkanStruk(nama,tanggal,databelanjaan):
    print("==================================")
...
#urutkan data
databelanjaan = urutkanData(databelanjaan)
#tampilkan output
tampilkanStruk(nama,tanggal,databelanjaan)